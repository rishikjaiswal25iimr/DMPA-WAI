...
tabs = st.tabs([
    "Executive Dashboard", "Project Overview", "Data Quality", "Exploratory Analysis",
    "Model Development", "Model Evaluation", "Feature Importance", "Prediction & Risk",
    "Maintenance Recommendations", "Methodology & Limitations",
])
